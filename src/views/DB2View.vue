<template>
 ...
 <ol>
   ...
   <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
   <li><a href="../BDb2">Conexiones de Db2.</a></li>
   <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
   <li class="pag">Db2.</li>
 </ol>
</nav>
      <br>
      <div>
        <h1 style="font-weight: bolder;">DB2.</h1>
      </div>
      <br><br>
      ...
      <div class="col-md-12"  style="margin-left: -130px; position: relative; top: -47.5px;">
          <a href="../BDB2"><button class="btn btn-default pull-right" type="button">Regresar</button></a>
        </div>
      <div class="row">
