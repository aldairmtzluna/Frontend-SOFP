<template>
    ...
    <ol>
      ...
      <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
      <li><a href="../BOracle">Conexiones Oracle.</a></li>
      <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
      <li class="pag">Oracle.</li>
    </ol>
  </nav>
      <br>
      <div>
        <h1 style="font-weight: bolder;">Oracle.</h1>
      </div>
      <br><br>
      ...
      <div class="col-md-12"  style="margin-left: -130px; position: relative; top: -47.5px;">
          <a href="../BOracle"><button class="btn btn-default pull-right" type="button">Regresar</button></a>
        </div>
      <div class="row">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const enviarFormulario = async () => {
        try {
          const response = await axios.post('http://127.0.0.1:8000/api/mysql/', formData);
          console.log(response.data);
          alert('Configuración de la base de datos actualizada correctamente.');
