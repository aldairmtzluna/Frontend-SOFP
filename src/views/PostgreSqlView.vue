  ...
  <div>
    ...
    <nav id="breadcrumb">
      <ol>
        ...
        <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
        <li><a href="/BPostgreSql">Conexiones PostgreSQL</a></li>
        <li><span class="icons icon-arrow" aria-hidden="true"></span></li>
        <li class="pag">PostgreSQL.</li>
      </ol>
    </nav>
    <br>
    <div>
      <h1 style="font-weight: bolder;">PostgreSQL.</h1>
    </div>
    <br><br>
    <form @submit.prevent="submitForm">
      ...
      <div class="row">
        <div class="col-md-2" style="margin-top: -90px;">
          <a href="../PostgreSql"><button class="btn btn-default pull-right" type="submit">Regresar</button></a>
        </div>
      </div>
    </form>
  </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const router = useRouter(); // Usa el enrutador de Vue

    const submitForm = async () => {
      try {
        const response = await axios.post('http://127.0.0.1:8000/api/postgresql-connections/', {
